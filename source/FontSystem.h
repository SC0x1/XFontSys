...
public:
	...
	//---------------------------------------------------------------------------
	virtual void	DrawOutLinedRect(const BBox_t&) = 0;
	virtual void	DrawOutLinedRect(const int x0, const int y0, const int x1, const int y1) = 0;
	virtual void	DrawFilledRect(const BBox_t&) = 0;
	virtual void	DrawFilledRect(const int x0, const int y0, const int x1, const int y1) = 0;
	virtual void	DrawLine(const int pX0, const int pY0, const int pX1, const int pY1) = 0;

	//---------------------------------------------------------------------------
	// Purpose: Sets color ( call before DrawOutLinedRect / DrawFilledRect / DrawLine )
	// Input  : uint8 r, uint8 g, uint8 b, uint8 a - rgb color
	//---------------------------------------------------------------------------
